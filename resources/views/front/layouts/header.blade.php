                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-center"><a href="#"><img class="img-thumbnail"
                                                    ...
                                                    src="front_assets/image/product/7product56x72.jpg"></a></td>
                        ...
                        <li>
                            <div>
                                ...
                                <p class="text-right"> <span class="btn-viewcart"><a href="cart.html"><strong><i
                                    ...
                                    <span class="btn-checkout"><a href="checkout.html"><strong><i
                                                    class="fa fa-share"></i> Checkout</strong></a></span> </p>
                            </div>
                        </li>
                    </ul>
                </div>
